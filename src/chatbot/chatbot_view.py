...
def get_chatbot_view(page: ft.Page) -> ft.Container:
    ...
    def add_message(message, is_user=True):
        chat_history.controls.append(
            ft.Container(
                ...
                bgcolor=colors.BLUE_700 if is_user else colors.BLUE_GREY_800,
                padding=10,
                border_radius=10,
    ...
    message_input = ft.TextField(
        ...
        border_color=colors.BLUE_GREY_600,
        hint_style=ft.TextStyle(color=colors.BLUE_GREY_400)
    )
    ...
    # Welcome message
    add_message("Hello! I'm your Developer Task Assistant. How can I help you with your coding or technical tasks today?", False)
        ...
        content=ft.Column(
            controls=[
                ...
                ft.Container(
                    ...
                    border=ft.border.all(1, colors.BLUE_GREY_600),
                    border_radius=10,
                    expand=True,
